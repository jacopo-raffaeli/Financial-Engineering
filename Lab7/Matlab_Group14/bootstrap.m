...
n_depos=sum(datesSet.depos<=datesSet.futures(1,1));
...
first_swap= mean(ratesSet.swaps(1),2);
rates_swaps = mean(ratesSet.swaps(2:end,:),2);
...
dates(1:n_depos) = datesSet.depos(1:3,:);
...
dates(n_depos+1:n_depos+n_futures) = datesSet.futures(1:7,2);
