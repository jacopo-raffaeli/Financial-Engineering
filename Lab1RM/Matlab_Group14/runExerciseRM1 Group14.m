...
%   1. Dirty price for a given risky bond (from hazard rate curve - fixed recovery rate R)
...
IG_h_curve = h_curve_bootstrap(IG_cf_schedule_1y, IG_Bond_dirty_price_1y, IG_cf_schedule_2y, IG_Bond_dirty_price_2y, ZC_curve, R);
HY_h_curve = h_curve_bootstrap(HY_cf_schedule_1y, HY_Bond_dirty_price_1y, HY_cf_schedule_2y, HY_Bond_dirty_price_2y, ZC_curve, R);
...
IG_z_1y = Z_spread(IG_cf_schedule_1y, IG_Bond_dirty_price_1y, ZC_curve);
IG_z_2y = Z_spread(IG_cf_schedule_2y, IG_Bond_dirty_price_2y, ZC_curve);
HY_z_1y = Z_spread(HY_cf_schedule_1y, HY_Bond_dirty_price_1y, ZC_curve);
HY_z_2y = Z_spread(HY_cf_schedule_2y, HY_Bond_dirty_price_2y, ZC_curve);
...
Q = Transiction_matrix(IG_h_curve(1,2), HY_h_curve(1,2))
